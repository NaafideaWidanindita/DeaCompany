...
// Tambahkan judul
$pdf->Cell(0, 10, 'Rekap Data Administrator', 0, 1, 'C');

// Set font untuk header tabel
$pdf->SetFont('Arial', 'B', 9);
$pdf->Cell(8, 7, 'ID', 1, 0, 'C'); 
...
$pdf->Cell(40, 7, 'Departemen', 1, 1, 'C'); 


// Set font untuk isi tabel
$pdf->SetFont('Arial', '', 8);
// Query untuk mendapatkan data pegawai
$sql_data_pegawai = "SELECT * FROM tb_pegawai WHERE tb_jabatan_id_jabatan = 1";
