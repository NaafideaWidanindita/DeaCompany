...
<head>
    ...
    <title>Edit Profile Pegawai</title>
...
<body>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Profile Pegawai</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Profile Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Edit Profile Pegawai</h3>
              </div>
              <!-- form start -->
