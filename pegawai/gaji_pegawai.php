...
<head>
    ...
    <title>Tarik Gaji Pegawai</title>
...
<body>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tarik Gaji Pegawai</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tarik Gaji Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-6">
            <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Tarik Gaji Pegawai</h3>
              </div>
              <!-- form start -->
          ...
          <div class="card card-yellow">
              ...
              <div class="card-body">
                  ...
                  if ($result_data_gaji->num_rows > 0) {
                      ...
                      echo '<p>Tidak ada data gaji yang telah diambil.</p>';
                  }
                  ?>
              </div>
          </div>
        ...
        if ($conn->query($sql_insert) === TRUE) {
            echo "<script>
                Swal.fire({
                  ...
                  if (result.value) {
                      window.location = 'index.php?hal=gaji_pegawai';
                  }
              });
                </script>";
        } else {
