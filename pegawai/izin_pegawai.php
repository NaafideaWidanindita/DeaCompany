...
<body>
   ...
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Buat Izin Pegawai</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Buat Izin Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Buat Izin Pegawai</h3>
              </div>
              <!-- form start -->
                ...
                if (move_uploaded_file($file_pendukung_tmp, $profil_path)) {
                    echo "<script>
                        Swal.fire({
                            ...
                            if (result.value) {
                                window.location = 'index.php?hal=daftarizin_pegawai';
                            }
                        });
                        </script>";
                } else {
                    echo "<script>
                        Swal.fire({
                            ...
                            if (result.value) {
                                window.location = 'index.php?hal=izin_pegawai';
                            }
                        });
                    </script>";
                }
