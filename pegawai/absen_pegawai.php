...
// Set the allowed time ranges for Absen Masuk and Absen Keluar
$allowedAbsenMasukStartTime = '08:00:00';
$allowedAbsenMasukEndTime = '09:15:00';

if (isset($_POST['btnMasuk'])) {
    // Check if it's within the allowed time range for Absen Masuk
...
if (isset($_POST['btnKeluar'])) {
    // Check if it's within the allowed time range for Absen Keluar
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Absen Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
