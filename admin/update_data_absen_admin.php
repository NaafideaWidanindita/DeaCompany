...
<head>
    ...
    <title>Edit Absensi Admin</title>
...
<body>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Absensi Admin</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit Absensi Admin</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-6">
            <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Edit Absensi Admin</h3>
              </div>
...
if (isset($_POST['btnUpdate'])) {
    ...
    if ($result_update) {
        ...
        echo '<script>window.location.href = "index.php?hal=data_absen_admin";</script>';
        exit();
    } else {
