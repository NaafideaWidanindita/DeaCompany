...
<body>
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rekap Absen Pegawai</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Rekap Absen Pegawai</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Rekap Absen Pegawai</h3>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="index.php?hal=update_data_absen_pegawai&id_absensi=<?= $row_absensi['id_absensi']; ?>"><i class="fas fa-edit"></i></a>
                          <a href="index.php?hal=delete_data_absen_pegawai&id_absensi=<?= $row_absensi['id_absensi']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                    }
