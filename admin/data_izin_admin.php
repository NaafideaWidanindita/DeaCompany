...
<body class="hold-transition sidebar-mini">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rekap Izin Admin</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Rekap Izin Admin</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?hal=update_data_izin_admin&id_izin=<?= $row_izin['id_cuti_izin']; ?>"><i class="fas fa-edit"></i></a>
                            <a href="index.php?hal=data_izin_deleteadmin&id_izin=<?= $row_izin['id_cuti_izin']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                    }
