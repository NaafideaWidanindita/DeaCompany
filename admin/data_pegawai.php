        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rekap Data Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card card-yellow">
              <div class="card-header">
                <h3 class="card-title">Rekap Data Pegawai</h3>
              </div>
              ...
              <div class="row">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td><a href="data_pegawai_print.php" target="_blank" class="btn btn-success" name="btnPrint" onclick="printData()"><i class="fa fa-file-pdf"></i> &nbsp PRINT</a></td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
