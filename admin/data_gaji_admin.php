...
$sql_fetch = "SELECT tb_pegawai.*, tb_gaji.gaji_bulan FROM tb_pegawai
              ...
              WHERE tb_pegawai.tb_jabatan_id_jabatan = 1";
...
<body>
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rekap Gaji Admin</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Rekap Gaji Admin</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-12">
                <div class="card card-yellow">
                    <div class="card-header">
                        <h3 class="card-title">Rekap Gaji Admin Yang Telah Diambil</h3>
                    </div>
